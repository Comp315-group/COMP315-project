...
MazeGame::MazeGame()
{
    ...
    {
        case 0:
            map = new Map("resource/map/maze/maze1.map", Map::Maze_map);
            break;

        case 1:
            map = new Map("resource/map/maze/maze2.map", Map::Maze_map);
            break;

        case 2:
            map = new Map("resource/map/maze/maze3.map", Map::Maze_map);
            break;

        case 3:
            map = new Map("resource/map/maze/maze4.map", Map::Maze_map);
            break;
